...
- For cabochons and bezel settings, set 'outline' from the shape word in the name (Oval/Round → 'oval', Rectangle/Square/Cushion → 'rectangle', Triangle → 'triangle', Pentagon → 'pentagon', Hexagon → 'hexagon', Teardrop/Pear → 'teardrop', Marquise → 'marquise', stalactite/agate slice → 'stalactite', trapiche slice → 'trapiche', Freeform → 'freeform'); null when the name has none. Everything else gets null.
