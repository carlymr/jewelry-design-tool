...
- Non-bead components get component shapes: 'chain' for link chain (length_mm always 25.4 — one placed element is a 1-inch segment; width_mm is the link width), 'jump-ring', 'lobster-clasp' (typical 12x6mm), 'toggle-clasp', 'connector' for straight bars with end loops, 'figure-eight' for infinity links and double-ring connectors, 'triangle' for triangle charms and open geometric shapes, 'cabochon' for flat-backed focal stones (use the stone's real dimensions — cabochons are large, e.g. 25x18mm; length_mm is the long axis). Metal components are almost always metallic finish in gold or silver tones.
