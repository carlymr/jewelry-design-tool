...
- Cabochon/bezel outline: set 'outline' from the shape word in the listing or the photo — Oval/Round → 'oval', Rectangle/Square/Cushion/Bar → 'rectangle', Triangle → 'triangle', Pentagon → 'pentagon', Hexagon → 'hexagon', Teardrop/Pear → 'teardrop', Marquise/Navette → 'marquise', stalactite or agate slices → 'stalactite', trapiche slices → 'trapiche', Freeform/irregular → 'freeform'. For bezel settings it is the recess shape. Null when nothing states or shows it.
