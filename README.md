...
- **Cabochons in settings**: select an undrilled cab and *Set into…* lists the bezel settings in your inventory that actually fit it (same shape, recess within 1.5 mm); the pair then draws and hangs as one pendant, the bezel's stock and cost count with the design, and *Unset* takes it back out
