...
- **Beyond beads**: chain (placed by the inch), lobster and toggle clasps, jump rings, connectors, and cabochons each render with their own treatment — cabochons according to how they're drilled (undrilled → placeholder bail, front-to-back → pinch bail, top-drilled → hangs from the wire, center-drilled → strung inline)
